...
agent = QwenAgent(device=device, accelerator=accelerator, 
                      policy_lm="", max_new_tokens=128)

#input_path = "/data/OOD/AITZ_ID/OOD_dataset/omniact-desktop.json"
#output_path = "/data3/OOD/AITZ_ID/OOD_dataset/omniact-desktop_embeddings.json"
#print("start get embeddings")
#get_embeddings_loop(input_path, output_path, agent)


#output_path = "/data3/OOD/AITZ_ID/train/AITZ_train_embedding.json"
#fitting_path = "/data3/OOD/AITZ_ID/train/AITZ_train_embedding_fitting.json"
#print("start Gaussian fitting")
#fitting = Gaussian_fitting(output_path, fitting_path)


#test_path = "/data3/OOD/long_prompt/OOD_dataset/omniact-web_embedding.json"
#test_output_path = "/data3/OOD/long_prompt/OOD_dataset/omniact-web_TVscore.json"

#test_path = "/data3/OOD/AITZ_ID/OOD_dataset/omniact-desktop_embeddings.json"
