...
class Qwen25Agent:
    def __init__(self, device, accelerator, cache_dir='~/.cache', dropout=0.5, policy_lm=None,processor=None,
                 max_new_tokens=32, use_bfloat16=False):
        self.model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
            policy_lm,  torch_dtype="bfloat16", device_map="auto", attn_implementation="flash_attention_2",
        ).to(device)
